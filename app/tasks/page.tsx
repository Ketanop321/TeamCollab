...
export default function TasksPage() {
  ...
  const [newTask, setNewTask] = useState({ title: "", assignee: "", dueDate: "", priority: "Medium", status: "todo" })
  ...
  const onDragEnd = (result) => {
    ...
    newTasks.splice(destination.index, 0, { ...reorderedItem, status: destination.droppableId })
